...
import { detectHandInImage } from "@/lib/handDetector";
      ...
      <div className="space-y-6">
        <div>
          <p className="mb-2 text-sm font-medium text-muted">
            {t("palmistry.tool.photo_label", { defaultValue: "Upload a photo of your palm (optional)" })}
          </p>
          <button
            type="button"
          ...
          >
            {checkingPhoto ? (
              ...
              <span className="px-6 text-center text-sm text-muted-soft">
                {t("palmistry.tool.photo_placeholder_upload", { defaultValue: "Tap to choose a photo from your device" })}
              </span>
            )}
          </button>
          <input
          ...
          <div className="mt-3">
            <button
              ...
              disabled={checkingPhoto}
              className="w-full rounded-xl border border-[var(--surface-border)] px-4 py-2.5 text-sm font-medium text-muted transition hover:border-[var(--accent-solid)] disabled:opacity-50"
            >
