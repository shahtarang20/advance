...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `/api/og?type=home&title=Cosmic%20Numbers&subtitle=Numerology%20%2B%20Horoscope&ext=.png`, width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Cosmic Numbers — Free Numerology Calculator & Daily Horoscope",
    description: "Discover your Life Path Number and daily horoscope, free and beautifully designed.",
    images: [`/api/og?type=home&title=Cosmic%20Numbers&subtitle=Numerology%20%2B%20Horoscope&ext=.png`],
  },
