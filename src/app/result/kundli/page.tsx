...
export async function generateMetadata({ searchParams }: { searchParams: Promise<SP> }): Promise<Metadata> {
  ...
  const ogUrl = `/api/og?type=kundli&title=${encodeURIComponent(input.name)}&subtitle=${encodeURIComponent(`Moon in ${moonRashi} · ${chart.moonNakshatra.name} Nakshatra`)}&ext=.png`;
