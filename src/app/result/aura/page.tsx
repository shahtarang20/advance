...
export async function generateMetadata({ searchParams }: { searchParams: Promise<SP> }): Promise<Metadata> {
  ...
  const ogUrl = `/api/og?type=aura&title=${encodeURIComponent(aura.name)}&subtitle=${encodeURIComponent(aura.chakra)}&color=${encodeURIComponent(aura.colorHex)}&ext=.png`;
  return {
    title,
    description,
